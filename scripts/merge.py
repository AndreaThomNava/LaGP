...
def main():
    ...
    with open(os.path.join(RESULTS_PATH, f"{setting}_{args.pickle_file_1}"), "rb") as f1:
        res_python = pickle.load(f1)

    with open(os.path.join(RESULTS_PATH, f"{setting}_{args.pickle_file_2}"), "rb") as f2:
